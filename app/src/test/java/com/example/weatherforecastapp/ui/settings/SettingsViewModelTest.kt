...
class SettingsViewModelTest {
    ...
    @Test
    fun setLanguage_language_nothing() = runBlockingTest {
        // Given : settingsViewModel already initialized

        // When : call function from fakeRepo
        val value = Locale.getDefault().language
        repo.setLocalization(value)


        //then: value from shared preferences should be equal to getFunction
        assertEquals(value, repo.getLocalization())
    }

    @Test
    fun setWind_wind_nothing() = runBlockingTest {
        // Given : settingsViewModel already initialized
        ...
        //then: value from shared preferences should be equal to getFunction
        assertEquals("Meter/Sec", repo.getWindSpeed())
    }

    @Test
    fun setAlarm_alarmString_nothing() = runBlockingTest {
        // Given : settingsViewModel already initialized

        // When : call function from fakeRepo
        val value = Const.NOTIFICATION
        repo.setAlarm(value)


        //then: value from shared preferences should be equal to getFunction
        assertEquals(value, repo.getAlarm())
    }
}